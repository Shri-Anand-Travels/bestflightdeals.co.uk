...
"use strict";
/*!**********************************************!*\
  !*** ./resources/js/flights-enquiry-form.js ***!
  \**********************************************/
  ...
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return (0,recaptcha_v3__WEBPACK_IMPORTED_MODULE_1__.load)(GOOGLE_CAPTCHA_SITE_KEY);
...
$('#flightsEnquiryForm').on('submit', /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 5:
            ...
            formData.append('enquiry_type', window.location.pathname.includes('search') ? 'SEARCH_FLIGHT_ENQUIRY' : 'FLIGHT_ENQUIRY');
            _context2.next = 11;
